      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="card">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div className="flex items-start gap-2">
              <span className="text-primary-500">✓</span>
              <span className="text-dark-text-secondary">DirectX / OpenAL 组件</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-primary-500">✓</span>
              <span className="text-dark-text-secondary">DLL 归属查询 + 错误码百科</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-primary-500">✓</span>
              <span className="text-dark-text-secondary">显卡驱动 / 内存完整性检测（全面扫描）</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-primary-500">✓</span>
              <span className="text-dark-text-secondary">快捷修复脚本 + AI 诊断报告</span>
            </div>
          </div>
        </div>
      </div>
